...
(x_train, y_train), (x_test, y_test) = mnist.load_data()  # Выгружаем данные из mnist (x - входные данные y - ожидаемый результат)
...
his = model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=10, batch_size=200) # Для большой сверточной модели
